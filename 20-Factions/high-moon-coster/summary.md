...
description: Remnant coster led by the Oberon family; bankrolling adventuring expeditions for a share of the profits, hoping for a windfall to restore the house.
---

# High Moon Coster

The most opportunistic of the three Remnant Costers. Where the [Iron Throne](../iron-throne/summary.md) brokers high-risk contracts and [Seven Suns](../seven-suns/summary.md) trades on luxury taste, the High Moon Coster — under the [Oberon family](people/oberon-family.md) — is openly **financing adventuring expeditions** for a percent of whatever comes back. One good ruin, one rare artifact, and the manor solvency problem goes away.

## Ideology

A small bet on every promising adventuring party in the city is cheaper than rebuilding a trading empire from scratch. The Oberons have given up on competing with the consortiums and are instead looking for a windfall — a Cloakwood ruin, a Sword Coast wreck, an Underdark relic — that no consortium would have the appetite to chase.
...
- [Oberon family](people/oberon-family.md) — leadership.
- [Iron Throne](../iron-throne/summary.md), [Seven Suns](../seven-suns/summary.md) — sister remnants.
- Source: `dossier-baldurs-gate-…` Part V Ch.12; `faction-quests.xlsx` (*Sponsor an Adventuring Party*, *Finance the Smugglers*).

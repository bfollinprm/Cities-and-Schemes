...
- **Glorify the Archduke.** Page-one praise for Silvershield's "Strategic Reserve Reallocation" (i.e., confiscation of [Outer City](../../../30-Places/sword-coast/baldurs-gate/outer-city/README.md) food stores) and night-raid against the Free Trader barricades.
- **Justify privatization.** Endorse the Sembian mercenary deployment, the [Counting House](../../../30-Places/sword-coast/baldurs-gate/lower-city/counting-house.md) fortification, and the "temporary cessation of unvetted, independent printing" — i.e., lock the city's other presses.

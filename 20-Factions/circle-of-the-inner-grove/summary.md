---
name: circle-of-the-inner-grove
description: Druidic sect protecting the Chionthar from the city's pollution and industrial expansion through escalating eco-sabotage.
---

# Circle of the Inner Grove

A small, secretive druidic sect that has watched the Chionthar for generations. The aggressive logging and industrial expansion of the **Decade of Reconstruction** has pushed them from passive guardians to **active saboteurs**. Led by [Elder Elion](people/elder-elion.md).

## Ideology

The city is a parasite, and unchecked growth a disease. The Circle holds that any action — including violence and ecological corruption — is justified if it preserves the balance of nature. Their guiding metaphor: they are the fever the world has summoned to fight the infection of Baldur's Gate.

## Membership

A small circle of druids and rangers who meet in a hidden grove upriver from the city. Led by **Elder Elion**, a wizened half-elf druid who remembers when the Chionthar ran clear. Membership is by invitation, and the circle is small enough that the loss of even one member is felt.
...
**Hooks.** Elion's most recent **Ritual of Warding** was corrupted by infernal residue — instead of strengthening forest creatures, it twisted them into fiendish, aggressive versions now attacking loggers and druids alike. A subsequent purification ritual at a tainted Chionthar tributary failed catastrophically: the corruption animated into a hostile **water weird** that broke loose into the main river and is now a direct threat to traffic.

## See also

- [Elder Elion](people/elder-elion.md) — leader.

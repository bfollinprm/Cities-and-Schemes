...
In **week 4** the cold war breaks. [Vex's public Velvet Hand raid](../guild/activity/week_4/retaliation.md) cripples Roah's east-end footprint with two dealers killed and the night's takings walked out the door. Roah's [smokepowder counter-strike against the Guild's Brampton headquarters is leaked by an informant inside the smuggling chain and the entire shipment is intercepted](activity/week_4/the-smokepowder-plot.md) — Roah loses the payload, loses the operatives carrying it, and exposes her intent. The Network has, however, [turned a Chandler-Guild informant in Eastway](../wc-chandlers-lamplighters/activity/week_4/eyes-in-the-dark.md) and now feeds Vex deliberately false intelligence through the lamplighter pipeline; and on Gray Harbour [Zhent enforcers have crushed One-Eyed Jack's guerilla rebellion with a public pier-side example](../wharf-rats/activity/week_4/the-pier-side-war.md), cementing visible Zhent muscle on Consortium docks.

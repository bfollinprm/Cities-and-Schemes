...
Leader of the [River-Rats](../summary.md) and chief specialist within [The Guild](../../guild/summary.md) for moving contraband through the **Undercity sewers** and **Chionthar coves**. The nickname is older than most of his crew remembers — a story about slipping out of three Flaming Fist nets in one night, with no consensus on which night it was.

## Manifesto

> The river is older than the city, and the sewers are older than the river. The Fist patrol the bridges. We patrol the dark. They count their tariffs by daylight, and by daylight we agree they are owed. By night, we agree to nothing.

## Role

Silas reports to one of Nine-Fingers Keene's **Sachems** (the district Lieutenant overseeing the docks and Brampton). He runs the River-Rats' day-to-day operations: which routes are used, which patrols are bribed, which contracts are taken. He maintains a small flat above a Brampton tannery — chosen, he says, because no one ever lingers near it.

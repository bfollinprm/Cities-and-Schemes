---
name: harpers
description: Semi-secret balance-keepers gathering intelligence and subtly intervening against the corrupt powers reshaping Baldur's Gate.
---

# The Harpers

A semi-secret organization dedicated to **preserving balance and fighting tyranny** in Baldur's Gate, working behind the scenes to gather information and subtly intervene against any faction — Council, Kontor, Guild, or cult — that threatens to consolidate total power. The local cell is led by [a figure known only as "The Nightingale"](people/the-nightingale.md).

## Ideology

To gather intelligence, identify abuses of power, and intervene in the most subtle ways possible. The Harpers do not seek to rule. They seek only to ensure no single power chains the city. Inspired locally by the legacy of the legendary Jaheira, the cell has shifted its post-crisis focus from overt threats (the Absolute, mind flayers) to the slower rot of corruption and plutocracy.

## Membership

A loosely organized cell of spies and agents hidden at every level of society:

- **Bards** in noble salons and on the festival circuit.
- **Magistrates** quietly placed in the legal system.
- **Merchants and dockhands** at the harbor and the gates.
- **Field operatives** like Randal Evenwood, who handles inside-jobs and infiltration.

The cell uses the [Waterdhavian Kontor](../waterdhavian-kontor/summary.md)'s **Splendid Yard** as its unofficial headquarters and the tavern **Danthelon's Dancing Axe** as a recruiting front.

...
description: Resurgent diabolist secret society of merchants and nobles, rebuilding their network of infernal pacts among the dispossessed elite.
---
...
Cells with limited knowledge of each other. Recruiters target the **dispossessed elite** — bankrupted patriars, burgled merchants, manorborn nobles whose protection has failed. Pacts are sworn in cellars and private rooms; recruits who refuse the oaths are not always allowed to walk away cleanly.
...
**Recruiter.** Codenamed **"the Hidden Lord"** — see [the-recruiter.md](people/the-recruiter.md) for the working pattern. No individual name in source.
...
- [The Recruiter](people/the-recruiter.md) — codename "the Hidden Lord"; recruitment pattern.
- [Patriar Heritage Society](../patriar-heritage-society/summary.md) — the demographic the Knights are poaching from.
- Source: `dossier-baldurs-gate-…` Part V Ch.12; `faction-quests.xlsx`; `dm-notes.docx`.

---
name: session-28-gm-summary
description: GM summary for session 28 — opening week 7 with the post-Needle press, Dammon's reveal of Karlach's iron, the Guild coin into Tumbledown, the Cliffside-Consecration patrol pressure.
---

# Session 28 — GM Summary
...
- **Mechanical.** Bror gets +1 to hit on unarmed strikes via Dammon's gauntlets. (Free, gift; Dammon owes the party for [the Reverse Siege pivot](../../20-Factions/party/activity/week_6/the-reverse-siege-pitch.md).)
- **Narrative.** Spark's cloak comes from **Karlach's original heart**. This continues last session's Bror question (*are you Karlach?*). The Followers of the Phoenix already half-believe Spark is a Karlach incarnation; this scene is the GM-side seed for whether Spark eventually has to *publicly* refuse or accept the role. Alfira is the next conversation.
- **Misdirection.** Dammon does not know the cloak's iron is *recently* salvaged. Implication: someone in the Foundry Smiths has access to original-Karlach material the party did not know existed. Open thread.
...
- **Why the gate is easy.** [The Vintners' Dry Riot](../../20-Factions/wc-vintners-brewers/activity/week_7/the-dry-riot.md) has the Sembian sergeants chasing deserters. The party's bad disguises are not noticed because the gate detail is not looking. *Treat this as a gift the players earn from upstream city-state chaos, not a roll they passed.*
- **The Gravekeeper patrol.** [Hemlock's Cliffside Consecration](../../20-Factions/gravekeepers/activity/week_7/the-cliffside-consecration.md) means the Tumbledown perimeter is operationally hot. The five gravediggers in the next yard are not there *for* the party — they're a routine consecration patrol — but they will engage on sight if the party is not very careful with the Guild coin and Grit's name.
...
- [Party — Cross the Eastway Blockade to Tumbledown](../../20-Factions/party/activity/week_7/cross-the-eastway-blockade-to-tumbledown.md)
- Source: `.context/converted/player-companion.md` (Session 28). DM-notes for week 7 are not yet present in the source document.

---
name: lower-city
description: Crescent of commerce between the Old Wall and [Gray Harbour](gray-harbour.md); the city's beating heart.
---

# Lower City

The chaotic, energetic, dangerous crescent of humanity pressed between the bluff of the [Upper City](../upper-city/README.md) and the waters of the [Gray Harbour](gray-harbour.md). The city's real work happens here. A maze of slate-roofed tenements, workshops, raucous taverns, and bustling marketplaces, all packed together and crisscrossed by bridges and buttresses to keep them from sliding into the harbor.
...
- [heapside.md](heapside.md) — northeast workshops, **[Sorcerous Sundries](sorcerous-sundries.md)**, the Baldur's Mouth printshop.
...
- [elfsong.md](elfsong.md) — Lower City tavern; Silver Fist Fund payout node.

### Notable houses

- [blushing-mermaid.md](blushing-mermaid.md) — dockside tavern; cheap information, cheaper fights.
- [counting-house.md](counting-house.md) — port bank and clearinghouse; the ledger room of the harbour.
- [elfsong-tavern.md](elfsong-tavern.md) — singing-ghost tavern; back-channel for off-duty Fist and fixers.
- [sorcerous-sundries.md](sorcerous-sundries.md) — Lorroakan's tower; seat of the Sorcerous Sodality.

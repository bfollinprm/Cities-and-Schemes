...
The most significant portion lies south of the Chionthar, connected to the city by **[Wyrm's Crossing](wyrms-crossing.md)**.
...
- [rivington.md](rivington.md) — south-bank gateway; caravan yards and [Open Hand Temple](open-hand-temple.md).
- [wyrms-crossing.md](wyrms-crossing.md) — bridge-and-fortress neighborhood; **[Wyrm's Rock](wyrms-rock.md)**.
...
- [open-hand-temple.md](open-hand-temple.md) — Ilmaran refuge in Rivington; bread, beds, and the city's most reliable plague clinic.
- [wyrms-rock.md](wyrms-rock.md) — Flaming Fist headquarters; the Marshal's tower and the city's drawbridge keys.
- [wyrms-bend-market.md](wyrms-bend-market.md) — south-bank market and the Free Traders' operating base.

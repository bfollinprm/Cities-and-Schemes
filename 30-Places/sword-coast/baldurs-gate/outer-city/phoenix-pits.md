---
name: phoenix-pits
description: Unlicensed cage-fight venue on the southern edge of New Elturel; Karlach-cult adjacent and a dead-end for Sodality scrying.
---

# The Phoenix Pits

A ring of sand-floored cage pits on the southern, ragged edge of [New Elturel](new-elturel.md), where unsanctioned bare-knuckle bouts run by night under torchlight. Named for Karlach — the *Phoenix* — and run with the half-wink, half-sermon energy of [Followers of the Phoenix](../../../../20-Factions/followers-of-the-phoenix/summary.md) preaching from the rim. The fights are not officially Karlach-cult; the recruitment is.
...
Informally — a handful of senior Hellrider veterans and a Karlach-aligned promoter. No charter, no master, no books. Disputes get settled in the ring or, more often, by everyone agreeing not to settle them.

## See also

- [new-elturel.md](new-elturel.md) — the borough that hosts it.
- [Followers of the Phoenix](../../../../20-Factions/followers-of-the-phoenix/summary.md) — recruit here, but don't run it.
- [Worshipful Company of Sorcerous Sodality](../../../../20-Factions/wc-sorcerous-sodality/summary.md) — for the Zora case file the Pits are tied to.

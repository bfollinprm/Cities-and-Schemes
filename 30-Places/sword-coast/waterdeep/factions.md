---
name: waterdeep-factions
description: Cross-link table of factions active in Waterdeep, with one-line role-in-the-city.
type: city-factions
---

# Waterdeep — Factions

Cross-link table only. Faction prose lives in [`20-Factions/`](../../../20-Factions/); this file says *what each one is doing in this city*.

## Lords' Alliance state apparatus
...
| [Xanathar Guild](xanathars-guild.md) | Beholder-led empire under the city. Distributes addictive **Black Lilly**; slave trade, protection rackets. Mind-flayer **Nihiloor** plants intellect devourers in citizens (e.g., Meloon Wardragon). Linked to Skullport. |
...
- [governance.md](governance.md), [character.md](character.md).
- Any cross-cut faction with a Waterdeep cell links here from its `summary.md`.

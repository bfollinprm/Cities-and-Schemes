...
The cosmic and planar scaffolding of the campaign: the courts of the immortal, the planes that brush against the Material, and the threats that move between them. Distinct from `20-Factions/` (campaign actors) and `30-Places/` (Material-Plane geography).
